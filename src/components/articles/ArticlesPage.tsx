  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl text-gray-900">Artykuły Naukowe</h1>
          <p className="text-gray-600 mt-1">Publikuj i udostępniaj swoje badania</p>
        </div>
      ...
      {articles.length === 0 ? (
        <Card className="bg-white border-pink-200 p-12 text-center">
          ...
          <h3 className="text-gray-900 mb-2">Brak artykułów</h3>
          <p className="text-gray-600 mb-4">Zacznij dzielić się swoimi badaniami</p>
          <Button onClick={onCreateArticle} className="bg-pink-600 hover:bg-pink-700 text-white">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-6 mb-4 text-sm text-gray-600">
                  <div className="flex items-center gap-1">
                    ...
                    <span>{article.articleDetails?.citations || 0} cytowań</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Download className="w-4 h-4" />
                    <span>{article.articleDetails?.downloads || 0} pobrań</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Eye className="w-4 h-4" />
                    <span>{article.articleDetails?.views || 0} wyświetleń</span>
                  </div>
                </div>
